...
# start and end times, enter beginning and end of pay period you wish to view tips for
...
# choose what happens to unassigned tips
    ...
    # give_to_next_server: give them all to the next server to clock in. ie. an online order comes in at 9am, first server to clock in gets tip
